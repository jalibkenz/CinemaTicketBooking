package in.kenz.cinematicketbooking.payment.application.service.impl;
...
import in.kenz.cinematicketbooking.payment.domain.enums.PaymentStatus;
import in.kenz.cinematicketbooking.payment.infrastructure.repository.CollectionRequestRepository;
import in.kenz.cinematicketbooking.payment.infrastructure.repository.PaymentRepository;
import in.kenz.cinematicketbooking.payment.application.service.PaymentService;
                ...
                .orElseGet(() ->
                        collectionRequestRepository.save(
                                CollectionRequest.builder()
                                        .booking(booking)
                                        .amountDue(booking.getCinema().getPrice())
                                        .currency("INR")
                                        .active(true)
                                        .build()
                        )
